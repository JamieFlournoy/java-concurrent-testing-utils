...
This project uses the Gradle build system to automate builds. It currently uses Gradle version 5.1-rc-2. If you have no idea what Gradle is or how to use it, you may want to refer to the [Gradle User Manual for version 5.1](https://docs.gradle.org/5.1/userguide/userguide.html).
